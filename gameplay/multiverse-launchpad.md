---
description: >-
  Multiverse Launchpad — meme communities launch branded Astroverse worlds with
  their token, mascot, and economy rules.
icon: rocket-launch
layout:
  width: wide
---
...
* **One launch flow** — go live from a single setup screen
...
Run challenges, utilities, and economies — social hubs and [on-chain ads](../on-chain-ads.md) amplify reach.
{% endstep %}
{% endstepper %}
...
**Custom meme-coin community branded metaverse Launchpad** is targeted for **Q3 2026** on the [Roadmap](../roadmap.md), alongside expanded casinos, clinics, shops, and social hubs.
