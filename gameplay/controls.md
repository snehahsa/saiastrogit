---
description: >-
  Controls & HUD — mobile and desktop play, live chat, joystick movement, nitro,
  radar, and options.
icon: mobile-screen
---
...
Astroverse X runs in the **browser** on modern **phones and desktops** — one client, two layouts. No download required for core play.
...
**No wallet connection required** for core play in the web client. Identity and eligibility can route through the **Telegram bot** — you don't need to connect a wallet just to start flying.

Details: [FAQ — wallet](../faq.md).

<a href="https://app.astroversex.com/" class="button primary">Launch controls in-game</a>
